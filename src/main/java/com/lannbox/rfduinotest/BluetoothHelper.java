...
public class BluetoothHelper {
    ...
    public static String getDevices(ArrayAdapter<BluetoothDevice> devices) {
        StringBuilder deviceMacList = new StringBuilder();
        for(int i=0; i < devices.getCount(); i++) {
            deviceMacList.append("Device: ").append(devices.getItem(i).toString());
        }
        return deviceMacList.toString();
    }
